...
import com.amit.interfaces.CustomizableByCode;
import com.amit.interfaces.OnAnimEndListener;
import com.amit.utilities.Utils;
import com.amit.utilities.UtilsKt;

public class CircularProgressButton extends AppCompatButton implements AnimButton, CustomizableByCode {
    private enum State {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            mParams.mSpinningBarColor = typedArray.getColor(R.styleable.CircularProgressButton_spinning_bar_color,
                    UtilsKt.Companion.getColorWrapper(context, android.R.color.black));
        ...
        mAnimatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (onAnimationEndListener != null) {
                    onAnimationEndListener.onAnimEnd();
                }
            }
        });
