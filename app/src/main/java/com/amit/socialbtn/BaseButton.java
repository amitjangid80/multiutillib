...
public class BaseButton extends AppCompatButton
{
    ...
    private void setStyle(int color, Context context)
    {
        ...
        setPadding((int) Utils.convertDpToPixel(30, context),
                0, (int) Utils.convertDpToPixel(30, context),
                0);
    }
    ...
    private void init(Context context, AttributeSet attrs, int logo)
    {
        ...
        textColor = array.getColor(R.styleable.BaseButton_android_textColor, Color.WHITE);
