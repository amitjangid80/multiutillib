...
public class ToolTip
{
    ...
    private ToolTip(MyContext myContext, View view)
    {
        this.view = view;
    ...
    private ToolTip(MyContext myContext, View rootView, View view)
    {
        this.view = view;
    ...
    public static ToolTip on(final View view)
    {
        return new ToolTip(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static ToolTip on(Fragment fragment, final View view)
    {
        return new ToolTip(new MyContext(fragment), view);
    }

    public static ToolTip on(Activity activity, final View view)
    {
        return new ToolTip(new MyContext(getActivityContext(activity)), view);
    }

    public static ToolTip on(Activity activity, final View rootView, final View view)
    {
        return new ToolTip(new MyContext(getActivityContext(activity)), rootView, view);
    }
    ...
    public ToolTip duration(long duration)
    {
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public ToolTip color(int color)
    {
        this.tooltip_view.setColor(color);
        return this;
    }

    public ToolTip color(Paint paint)
    {
        this.tooltip_view.setPaint(paint);
        return this;
    }

    public ToolTip onDisplay(ListenerDisplay listener)
    {
        this.tooltip_view.setListenerDisplay(listener);
        return this;
    }

    public ToolTip onHide(ListenerHide listener)
    {
        this.tooltip_view.setListenerHide(listener);
        return this;
    }

    public ToolTip padding(int left, int top, int right, int bottom)
    {
    ...
    public ToolTip animation(TooltipAnimation tooltipAnimation)
    {
    ...
    public ToolTip text(@StringRes int text)
    {
        this.tooltip_view.setText(text);
        return this;
    }

    public ToolTip corner(int corner)
    {
    ...
    public ToolTip textTypeFace(Typeface typeface)
    {
        this.tooltip_view.setTextTypeFace(typeface);
        return this;
    }

    public ToolTip textSize(int unit, float textSize)
    {
        this.tooltip_view.setTextSize(unit, textSize);
        return this;
    }

    public ToolTip margin(int left, int top, int right, int bottom)
    {
        this.tooltip_view.setMargin(left, top, right, bottom);
        return this;
    }

    public ToolTip setTextGravity(int textGravity)
    {
        this.tooltip_view.setTextGravity(textGravity);
        return this;
    }

    public ToolTip clickToHide(boolean clickToHide)
    {
        this.tooltip_view.setClickToHide(clickToHide);
        return this;
    }

    public ToolTip autoHide(boolean autoHide, long duration)
    {
    ...
    public ToolTip distanceWithView(int distance)
    {
        this.tooltip_view.setDistanceWithView(distance);
        return this;
    }

    public ToolTip border(int color, float width)
    {
    ...
    public static class ToolTipView extends FrameLayout
    {
        ...
        private Paint bubblePaint, borderPaint;
        ...
        public void setMargin(int left, int top, int right, int bottom)
        {
            ...
            childView.setPadding(
                    childView.getPaddingLeft() + left,
                    childView.getPaddingTop() + top,
                    childView.getPaddingRight() + right,
                    childView.getPaddingBottom() + bottom);
        ...
        protected void onSizeChanged(int w, int h, int oldw, int oldh)
        {
            ...
            bubblePath = drawBubble(new RectF(shadowPadding, shadowPadding, w - shadowPadding * 2, h - shadowPadding * 2), corner, corner, corner, corner);
        }
        ...
        private Path drawBubble(RectF myRect, float topLeftDiameter, float topRightDiameter, float bottomRightDiameter, float bottomLeftDiameter)
        {
            ...
            path.moveTo(left + topLeftDiameter / 2f, top); //LEFT, TOP
            ...
            path.quadTo(right, top, right, top + topRightDiameter / 2); //RIGHT, TOP
            ...
            path.quadTo(right, bottom, right - bottomRightDiameter / 2, bottom); //RIGHT, BOTTOM
            ...
            path.quadTo(left, bottom, left, bottom - bottomLeftDiameter / 2); //LEFT, BOTTOM
